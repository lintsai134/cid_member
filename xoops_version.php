...
//---模組基本資訊---//
$modversion['name']        = 'CID會員';
$modversion['version']     = 1.00;
$modversion['description'] = '管理本會會員模組';
$modversion['author']      = 'Johnny';
$modversion['credits']     = '';
...
$modversion['module_website_url']  = 'https://lin.ichiayi.com';
$modversion['module_website_name'] = '宗霖小站';
$modversion['module_status']       = 'release';
$modversion['author_website_url']  = 'https://lin.ichiayi.com';
$modversion['author_website_name'] = '宗霖小站';
$modversion['min_php']             = 5.4;
$modversion['min_xoops']           = '2.5';

//---paypal資訊---//
$modversion['paypal']                  = array();
$modversion['paypal']['business']      = 'lin.ichiayi@gmail.com';//作者@的Email
...
$i                                          = 1;
$modversion['templates'][$i]['file']        = 'adm_main.tpl';
